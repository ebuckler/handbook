...
- We show up as experts for our partners, so that we mesh their knowledge of their needs with our knowledge of technology, web and trends to deliver the most value.
- We explain trade-offs to partners and help them evaluate the options so that they can ensure the decision is the right one for the project.
- We are true to our partners underlying needs and best interests, and do not simply do what they ask so that they get the site that solves the right problems for the right people, is maintainable and delivered within the right budget and timeline.

### Participate in Project Discovery

- As part of a product team, we double-check assumptions made at the outset of a project around budget and timeline.
- We ensure we have sufficient time to discover the scope of our problem set.
- We document our finding as much as possible in a transparent way, so that the team can see and appropriately address those findings.
- We flag any requirements that are likely to cause dev problems for the product manager.
...
- We educate and involve partners in expecting and managing risk.
...
- We escalate problems quickly to the tech lead, PM and/or engagement manager if we encounter issues that could block progress, momentum, or success.

### Show, don't tell our partners

- We give frequent demos and get partners using the site early on, so that they can give us effective feedback and prioritization.
- We try to identify paths towards self-sufficiency for our team and partners where possible.
- We add good help text for content creators.
- We document where metrics are stored.
- We support the use of user testing, analytics tools, A-B testing for metrics.
...
- Working together and talking through a task, screensharing.
...
- Not giving the work your full attention. If you need a break, say so!
...
While process may change based on project needs these resources can provide a foundation when necessary.

Some purposes of providing a process for technical design are to:

- clarify problem statements and value provided.
...
- Discover your audience and keep them in mind while writing.
  ...
  - Partners, Product Managers, and/or Team Leads looking for a solution overview and resource considerations.
...
Allowing time for growth ensures consistent, high quality work which benefits everyone.
